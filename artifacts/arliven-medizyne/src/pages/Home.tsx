            ...
            {features.map((feature, idx) => (
              <FadeIn key={idx} delay={idx * 0.08} direction="up">
                <motion.div
                  ...
                  className="bg-white rounded-2xl border border-[#2F80ED]/12 group cursor-default overflow-hidden shadow-sm"
                >
                  ...
                  <div className="p-6">
                    <div className="w-10 h-10 bg-[#EAF2FF] rounded-xl flex items-center justify-center text-[#2F80ED] mb-4 group-hover:bg-[#2F80ED] group-hover:text-white transition-colors duration-300">
            ...
            {services.map((service, idx) => (
              <FadeIn key={idx} delay={idx * 0.08}>
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                  className="bg-white border border-[#2F80ED]/12 rounded-2xl overflow-hidden group cursor-default h-full flex flex-col shadow-sm"
                >
                  ...
                  <div className="p-5 flex-1">
                    ...
                    <h3 className="text-sm font-bold mb-2 text-[#1D1D1F] group-hover:text-[#2F80ED] transition-colors leading-snug">{service.title}</h3>
            ...
            <FadeIn direction="right">
              ...
              <ul className="space-y-3">
                {["Southeast Asia", "African Nations", "Middle East / GCC", "CIS Countries"].map((region, i) => (
                  <FadeIn key={i} delay={i * 0.08} direction="right">
                    <div className="flex items-center gap-3 bg-white rounded-xl px-4 py-3 border border-[#2F80ED]/15 shadow-sm">
