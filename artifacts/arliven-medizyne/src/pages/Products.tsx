...
const products = [
  ...
  },
  {
    ...
    description: "Sterile injectable solutions for hospital supply and general therapeutic use.",
    items: ["Hospital Supply Products", "General Injections"],
  },
  {
    category: "Surgical Products",
    icon: BriefcaseMedical,
    image: "pharma-surgical.png",
    description: "Essential surgical consumables and protective equipment for clinical and hospital use.",
    items: ["Gloves", "Masks", "Syringes", "Medical Consumables"],
  },
  {
    category: "Medical Consumables",
    icon: Shield,
    image: "pharma-factory.png",
    description: "Broad range of medical consumables for healthcare institutions and global supply.",
    items: ["Disposable Items", "Dressings & Bandages", "IV Sets", "Diagnostic Consumables"],
  },
];
            ...
            {products.map((product, idx) => (
              <FadeIn key={idx} delay={idx * 0.08}>
                <motion.div
                  ...
                  className="bg-[#EEF4FF] rounded-2xl overflow-hidden border border-[#2F80ED]/10 h-full flex flex-col shadow-[0_2px_12px_rgba(47,128,237,0.07)]"
                >
                  <div className="h-48 overflow-hidden relative">
                    ...
                    <div className="absolute bottom-3 left-3 w-10 h-10 bg-white rounded-xl flex items-center justify-center text-[#2F80ED] shadow-md">
            ...
            <FadeIn>
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {services.map((service, idx) => (
                  <div key={idx} className="flex items-center gap-3 bg-[#EEF4FF] rounded-xl px-4 py-3 border border-[#2F80ED]/10 lift-card">
